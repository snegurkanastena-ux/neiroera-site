...
export const messagesByLang: Record<Lang, Messages> = {
  ru: {
    ...
    hero: {
      title:
        "Собираю сайты, ИИ-ассистентов и понятную упаковку,\nчтобы к вам могли нормально обратиться",
      typingLines: JSON.stringify([
        "Собираю сайты, ИИ-ассистентов и понятную упаковку,\nчтобы к вам могли нормально обратиться",
        "Лендинг от 10 000 ₽, сайт от 25 000 ₽, ИИ-ассистент 20 000 ₽",
        "Стикеры для бизнеса от 2 000 ₽: Telegram, MAX и Битрикс"
      ]),
      subtitle:
        "Помогаю собрать страницу или сайт, сценарий заявки, полезные ссылки, оплату и ИИ-инструменты так, чтобы человеку не приходилось спрашивать одно и то же в личке",
      whatYouGet: "С чего можно начать:",
      bullets: JSON.stringify([
        "лендинг или простой сайт от 10 000 ₽",
        "многостраничный сайт от 25 000 ₽",
        "ИИ-ассистент 20 000 ₽, разбор 5 000 ₽, стикеры от 2 000 ₽"
      ]),
      trust1: "сайты и заявки",
      trust2: "боты и ИИ",
      trust3: "портфолио с реальными проектами",
      ctaConsult: "Хочу сайт",
      ctaRequest: "Сначала разобраться",
      ctaTg: "Telegram"
    },
    about: {
      kicker: "Обо мне",
    ...
    portfolio: {
      kicker: "Портфолио",
      title: "Сайты, боты, приложения и стикеры",
      intro: "Показываю не только картинки, а задачи: что нужно было собрать, какой путь для клиента появился и где стало проще оставить заявку.",
      open: "Открыть",
      ...
      items: [
        {
          title: "ИИ-коуч по трансформации",
          desc: "Персональный ИИ-помощник, который задает вопросы, помогает фиксировать состояние, возвращает к цели и дает следующий шаг.",
          anchor: "portfolio-ai-coach"
        },
        {
          title: "OpenClaw-бот Кузя",
          desc: "ИИ-бот-персонаж с голосом, памятью, правилами поведения и технической основой для запуска через OpenClaw и Telegram.",
          anchor: "portfolio-kuzya"
        },
        {
          title: "Rankofe",
          desc: "Проект для кофейни: приложение, клуб и цифровая логика для связи с гостями и возвращения людей в бренд.",
          anchor: "portfolio-rankofe"
        },
        {
          title: "Стикеры для бизнеса",
          desc: "Наборы для Telegram, MAX и сценариев коммуникации в Битрикс. Цена — от 2 000 ₽.",
          anchor: "portfolio-stickers"
        },
        {
          title: "Нейрофото и визуалы",
          desc: "Обложки, визуалы для соцсетей и рекламы — быстро, в едином стиле и с сильным кадром.",
          anchor: "portfolio-photos"
        },
        {
          title: "Видео, клипы и музыка",
          desc: "Сценарии, монтаж, звук и визуал в связке с AI-инструментами.",
      ...
      cards: [
        {
          ...
          priceLine: "от 10 000 ₽",
          details: [
            { name: "Лендинг / простая страница", price: "от 10 000 ₽" },
            { name: "Многостраничный сайт", price: "от 25 000 ₽" },
            { name: "Сценарий заявки и кнопки", price: "входит" }
          ]
        },
        {
          id: "automation",
          ...
          priceLine: "20 000 ₽",
          details: [
            { name: "Ответы на частые вопросы", price: "входит" },
            { name: "Сбор вводных", price: "входит" },
            { name: "Сценарий до заявки", price: "входит" }
          ]
        },
        {
          id: "content",
          ...
          priceLine: "от 5 000 ₽",
          details: [
            { name: "Разбор", price: "5 000 ₽" },
            { name: "Полезные ссылки и путь клиента", price: "по задаче" },
            { name: "Тексты для страницы", price: "по задаче" }
          ]
        },
        {
          id: "creative",
          ...
          priceLine: "от 2 000 ₽",
          details: [
            { name: "Набор для Telegram", price: "от 2 000 ₽" },
            { name: "Адаптация под MAX", price: "по задаче" },
            { name: "Сценарии для Битрикс", price: "по задаче" }
          ]
        },
        {
          id: "training",
          ...
          priceLine: "5 000 ₽",
          details: [
            { name: "Разбор текущей точки входа", price: "5 000 ₽" },
            { name: "Что выбрать: сайт, ИИ или упаковку", price: "входит" },
            { name: "План первого шага", price: "входит" }
          ]
        }
      ]
    },
  ...
  en: {
    ...
    serviceItems: {
      ...
      stickers: {
        ...
        desc: "Sticker packs for Telegram, MAX, and Bitrix communication scenarios. From 2,000 ₽.",
        action: "Add to estimator"
      },
      custom: {
