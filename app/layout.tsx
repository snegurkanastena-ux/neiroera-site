...
export const metadata: Metadata = {
  title: "НейроЭра — сайты, ИИ-ассистенты и понятная упаковка",
  description:
    "Сайты, ИИ-ассистенты, приложения, клубы и стикеры для бизнеса, чтобы к вам могли нормально обратиться"
};
